...
it('should set the tiny spacing class in addition to the base class when itemSpacing is "tiny"', () => {
...
it('should set the split class in addition to the base class when splitAt is "extraTiny"', () => {
  const wrapper = shallow(
    <SprkStack splitAt="extraTiny" />,
  );
  expect(wrapper.find('div.sprk-o-Stack').hasClass('sprk-o-Stack--split@xxs')).toBe(true);
});

it('should set the split class in addition to the base class when splitAt is "tiny"', () => {
  const wrapper = shallow(
    <SprkStack splitAt="tiny" />,
  );
  expect(wrapper.find('div.sprk-o-Stack').hasClass('sprk-o-Stack--split@xs')).toBe(true);
});

it('should set the split class in addition to the base class when splitAt is "small"', () => {
  const wrapper = shallow(
    <SprkStack splitAt="small" />,
  );
  expect(wrapper.find('div.sprk-o-Stack').hasClass('sprk-o-Stack--split@s')).toBe(true);
});

it('should set the split class in addition to the base class when splitAt is "medium"', () => {
  const wrapper = shallow(
    <SprkStack splitAt="medium" />,
  );
  expect(wrapper.find('div.sprk-o-Stack').hasClass('sprk-o-Stack--split@m')).toBe(true);
});

it('should set the split class in addition to the base class when splitAt is "large"', () => {
  const wrapper = shallow(
    <SprkStack splitAt="large" />,
  );
  expect(wrapper.find('div.sprk-o-Stack').hasClass('sprk-o-Stack--split@l')).toBe(true);
});

it('should set the split class in addition to the base class when splitAt is "huge"', () => {
  const wrapper = shallow(
    <SprkStack splitAt="huge" />,
  );
  expect(wrapper.find('div.sprk-o-Stack').hasClass('sprk-o-Stack--split@xl')).toBe(true);
});
