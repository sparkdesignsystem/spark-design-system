...
Our <a href="https://github.com/sparkdesignsystem/spark-starter-react/" target="_blank">Starter Github Repositories</a> are available for reference:
...
1. Download the required packages with this command. It contains all
...
Adding a Spinner Button can confirm you've installed Spark React packages correctly. It will also get you started with some functionality.
