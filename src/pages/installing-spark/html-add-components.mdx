...
down on the Button page to find <a href="https://html.sparkdesignsystem.com/?path=/docs/components-button--loading" target="_blank">Loading Button</a>.
...
> **For example**: If you’ve added a Loading Button
