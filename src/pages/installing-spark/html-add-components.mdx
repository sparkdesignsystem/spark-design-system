...
Our <a href="https://github.com/sparkdesignsystem/spark-starter-html/" target="_blank">Starter Github Repositories</a> are also available for reference:
...
2. In the `index.js` file, import `setSpinning` from Spark and create a `startSpinner` function (this is the function that will run `onclick`).
```javascript
