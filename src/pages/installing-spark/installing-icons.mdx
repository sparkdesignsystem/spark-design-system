...
[https://github.com/sparkdesignsystem/spark-design-system/blob/staging/gatsby-config.js#L55](https://github.com/sparkdesignsystem/spark-design-system/blob/staging/gatsby-config.js#L67)
...
as the icons listed on this [page](/using-spark/components/icon). 

### Resources

For more information on usage and customization of
Spark Icon components, check out our [documentation](/using-spark/components/icon)
and storybook pages.
- [HTML](https://html.sparkdesignsystem.com/?path=/story/components-icons--default-story)
- [React](https://react.sparkdesignsystem.com/?path=/story/components-icons--default-story)
- [Angular](https://angular.sparkdesignsystem.com/?path=/story/components-accordion--default-story) 
