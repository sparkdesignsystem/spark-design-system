...
development environment. You can also check out [Part 2 - HTML Installation](./vanilla-installation) and
[Part 3 - HTML Components](./vanilla-add-components).

For instructions on setting up Spark in other environments, check out the guides for
[Angular](./angular) and [React](./react) development environments.
...
13. At the top of `index.js`, add this reference to the uncompiled `scss`
 file:
...
14. Now let’s write some CSS to compile. Create a new file in `src`
...
15. In `index.html`, add this reference to your new compiled CSS.
