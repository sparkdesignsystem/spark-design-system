...
<div class="sprk-o-Stack sprk-o-Stack--medium sprk-o-Stack--split@xl">
  <div class="sprk-b-TableContainer sprk-o-Stack__item sprk-u-mtl">
    ...
    <TypographyTable category="desktop" />
  </div>

  <div class="sprk-b-TableContainer sprk-o-Stack__item sprk-u-mtl">
    <h3 class="sprk-b-TypeDisplayFive">Mobile</h3>
    <TypographyTable category="mobile" />
  </div>
</div>
...
Use Page Title with [Display One](#display-one) to style primary headings on top-level pages in your experience.

Use Page Title with [Display Two](#display-two) to style primary headings on nested pages in your experience.
