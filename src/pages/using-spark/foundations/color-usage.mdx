...
<p>
  Button and link guidelines are one of the largest updates with the Orbit Color palette, specifically how color now has a further impact on the way we use and pair these components. To see more details, learn more on the Buttons and Links pages.
</p>
<SprkStack itemSpacing="medium" splitAt="small" additionalClasses="sprk-u-Measure">
  <SprkStackItem additionalClasses="sprk-o-Stack__item--half@s sprk-u-prm">
    <SprkCard>
      <h4>Buttons</h4>
      <p>
        View updates to our standards for effective button usage.
      </p>
      <SprkLink
        element="a"
  ...
  <SprkStackItem additionalClasses="sprk-o-Stack__item--half@s sprk-u-prm">
    <SprkCard>
      <h4>Links</h4>
      <p>
        View updates to our standard for effective link usage.
      </p>
      <SprkLink
        element="a"
