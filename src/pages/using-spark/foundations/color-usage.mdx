...
<p class="sprk-u-mbl sprk-b-TypeBodyTwo sprk-u-Measure">
  Our objective is to achieve human-centered design in everything we do and having a consistent and <a href="/using-spark/foundations/color-accessibility">WCAG AA accessible color palette</a> is just one of the foundations in creating this unified user experience.
</p>
