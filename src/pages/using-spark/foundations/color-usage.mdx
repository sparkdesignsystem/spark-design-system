...
<p class="sprk-u-mbl sprk-b-TypeBodyTwo sprk-u-Measure">
  We've curated this palette with color psychology and user testing in mind. We've designed it to be modern, human-centered, and <a href="/using-spark/foundations/color-accessibility">WCAG 2.1 (Level AA) accessible</a>.
</p>
<SprkDivider element="span" additionalClasses="sprk-u-mvn"/>
