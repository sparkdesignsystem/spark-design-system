...
This Alert has a Checkmark Icon and provides positive feedback to a user’s action.
...
This Alert has an Exclamation Icon with negative feedback to a user’s action.
