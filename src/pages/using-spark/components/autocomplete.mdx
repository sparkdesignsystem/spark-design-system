...
- Ensure the autocomplete input field is not blocking other elements on mobile.
...
To show a full list of options, use a Select Box (link).

## Research

The autocomplete pattern is based on the principle of recognition over recall.

For more on the Autocomplete pattern see
https://ui-patterns.com/patterns/Autocomplete