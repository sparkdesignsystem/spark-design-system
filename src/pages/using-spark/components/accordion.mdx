...
Use Accordion to separate supplementary content into digestible pieces.
...
- Accordion titles should be relevant to the content it reveals. A user should know exactly what expect to expect when they expand a section.
- If your instance only has one item, use the [Toggle Component](https://sparkdesignsystem.com/using-spark/components/toggle) instead.
...
- Accessible through keyboard.
  - TAB and SHIFT-TAB navigates through Accordion titles.
  - ENTER expands or collapses each section.