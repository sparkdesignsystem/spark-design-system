...
- Using semantic HTML Elements help search engines index pages and give more important to those that have them.
...
Use the strong and emphasis elements to add semantic meaning and enhance accessibility. Semantic elements inform assistive technologies such as screen readers of an emphasis that might not be visually accessible to all users.
...
When web elements are meaningful and contextual, that means it's **semantic**. Producing content with Semantic HTML ensures accessibility to as many users as possible.
