...
- Use **CSS** to style or decorate text. CSS styling **does not** add semantic meaning to content, unlike the strong element.
...
- Use the **emphasis element** `<em></em>` for stressing emphasis.
