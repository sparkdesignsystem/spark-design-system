...
- It's important to know and understand the purpose of each HTML tag to communicate the intended meaning of the enclosed text.
- Use the correct tag to communicate meaning and ensure content is accessible for assistive technologies.
...
> As a UX Writer, it's important to **understand** each HTML tag's **usage** and **purpose** to know when to use them, and ensure the content is communicating the **intended meaning**.
...
Browsers render the contents inside the Strong tag in **bold type**.
...
Browsers render the content inside the Emphasis tag in <em>Italic type</em>.
