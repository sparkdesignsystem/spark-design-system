...
describe('SparkPromoComponent', () => {
  ...
  it('should add classes when additionalClasses has a value', () => {
    ...
    expect(element.classList.toString()).toEqual('sprk-o-Stack sprk-o-Stack--split@s sprk-o-Stack--medium sprk-u-man');
  });
  ...
  it('should add additional classes to img link when additionalClassesImgLink has a value', () => {
    ...
    fixture.detectChanges();
    expect(element.querySelector('a').classList.toString()).toEqual('sprk-o-Stack__item sprk-u-man');
  });
  ...
  it('should it show the correct icon when icon is chosen as media type and iconType input has a value', () => {
    ...
    fixture.detectChanges();
    expect(element.querySelector('a svg use').getAttribute('xlink:href').toString()).toEqual('#' + 'bell');
  });
});
