...
@Component({
  ...
  template: `
    <div class="drizzle-o-ContentGrouping sprk-u-mbh">
      <div class="drizzle-o-ContentGrouping sprk-u-mbh">
        <h2 class="drizzle-b-h2 sprk-u-mbm">Award split at small breakpoint</h2>
      ...
      <div class="drizzle-o-ContentGrouping sprk-u-mbh">
        <h2 class="drizzle-b-h2 sprk-u-mbm">Award split at large breakpoint</h2>
      ...
      <div class="drizzle-o-ContentGrouping sprk-u-mbh">
        <h2 class="drizzle-b-h2 sprk-u-mbm">Award split at huge breakpoint</h2>
