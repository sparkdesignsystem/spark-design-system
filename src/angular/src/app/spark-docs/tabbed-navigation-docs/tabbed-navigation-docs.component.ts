...
@Component({
  ...
  template: `
    <div class="drizzle-o-ContentGrouping">
      <h2 class="drizzle-b-h2">Tabbed Navigation</h2>
      ...
      <sprk-tabbed-navigation idString="navigation-tabbed-1">
        ...
        <div sprkTabbedNavigationPanel>
          <p>
            ...
            elit. Sed quis rhoncus ipsum. Nulla euismod nisi est, vel consequat
            ante consectetur in. Ut interdum dictum est at ornare. Nam nec
            dapibus nibh. Integer venenatis ex eu mi euismod, non ultricies
            lacus venenatis.
          </p>
        </div>
