...
describe('SparkWideNavigationComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [SparkWideNavigationComponent, SparkIconComponent]
    }).compileComponents();
  }));
  ...
  it('should add any additional classes when additionalClasses has a value', () => {
    ...
    expect(wideNavigationElement.classList.toString()).toEqual(
      'sprk-c-WideNavigation sprk-u-man'
    );
  });
  ...
  it('should map incoming links to nav items', () => {
    ...
    fixture.detectChanges();
    expect(wideNavigationElement.querySelector('a').textContent.trim()).toEqual(
      'Item 1'
    );
  });
