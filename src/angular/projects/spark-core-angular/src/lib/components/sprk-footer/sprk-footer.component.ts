      ...
      >
        ...
        >
          ...
          >
            ...
            <p class="sprk-o-Stack__item sprk-b-TypeBodyTwo">{{ item.text }}</p>
          </div>
        </div>

        <div
          class="sprk-o-Stack__item sprk-o-Stack__item--three-fourths@m sprk-o-Stack sprk-o-Stack--medium"
        >
          <div
            *ngIf="localLinks"
          ...
          >
            ...
            >
              ...
              >
                <li *ngFor="let item of socialLinks" class="sprk-o-Stack__item">
                  <a
