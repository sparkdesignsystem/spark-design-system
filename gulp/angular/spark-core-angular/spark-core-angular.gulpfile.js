...
gulp.task('test-spark-core-angular', (cb) => {
  exec('cd src/angular/projects/spark-core-angular && ../../node_modules/.bin/ng test spark-core-angular --watch=false', (err, stdout, stderr) => {
    console.log(stdout);
    console.log(stderr);
    cb(err);
  });
