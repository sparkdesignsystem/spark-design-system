...
describe('SprkTabs Component', () => {
  it('SprkTabsButton: Should display a Tab Button element with the correct base class', () => {
  ...
  it('SprkTabsButton: Should have the active class if isActive is true', () => {
  ...
  it('SprkTabsButton: Should focus if isFocused is updated to true', () => {
  ...
  it('SprkTabsButton: Should not focus if isFocused is updated to false', () => {
  ...
  it('SprkTabsButton: Should add classes when tabBtnAddClasses has a value', () => {
    const wrapper = mount(<SprkTabsButton tabBtnChildren="Tab 1" isFocused tabBtnId="tab-52" tabBtnAddClasses="test">Test Content 1</SprkTabsButton>);
    wrapper.find('.sprk-c-Tabs__button').simulate('click');
    expect(wrapper.find('.sprk-c-Tabs__button.test').length).toBe(1);
  });

  it('SprkTabsButton: Should focus the next Tab Button when the right arrow key is pressed', () => {
    const wrapper = mount(
      <SprkTabs>
