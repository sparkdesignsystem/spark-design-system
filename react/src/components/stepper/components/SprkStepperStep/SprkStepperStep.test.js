...
// Root Element Tests
it('SprkStepperStep: Should display a stepperitem element with the correct base class', () => {
  const wrapper = shallow(<SprkStepperStep />);
  expect(wrapper.find('li.sprk-c-Stepper__step').length).toBe(1);
});

it('SprkStepperStep: Should correctly apply the title property', () => {
...
it('SprkStepperStep: Should correctly apply additional classes', () => {
...
it('SprkStepperStep: Should correctly apply idString', () => {
...
it('SprkStepperStep: Should correctly apply analyticsString', () => {
...
it('SprkStepperStep: Should have the correct structure for hasDescription', () => {
...
it('SprkStepperStep: Should correctly hide selected description (covered by slider)', () => {
