...
it('SprkMastheadDropdown: Should render a trigger with the correct classes', () => {
  const wrapper = mount(<SprkMastheadDropdown />);
  expect(wrapper.find('.sprk-b-Link').length).toBe(1);
});

it('SprkMastheadDropdown: Should add classes to the dropdown when additionalClasses has a value', () => {
  const wrapper = mount(
...
it('SprkMastheadDropdown: Should add classes to the icon when additionalIconClasses has a value', () => {
  const wrapper = mount(
...
it('SprkMastheadDropdown: Should add classes to the trigger when additionalTriggerClasses has a value', () => {
  const wrapper = mount(
...
it('SprkMastheadDropdown: Should add classes to the trigger text when additionalTriggerTextClasses has a value', () => {
  const wrapper = mount(
...
it('SprkMastheadDropdown: Should assign data-analytics when analyticsString has a value', () => {
  const wrapper = mount(<SprkMastheadDropdown analyticsString="321" />);
  expect(wrapper.find('[data-analytics="321"]').length).toBe(2);
});

it('SprkMastheadDropdown: Should assign data-id when idString has a value', () => {
  const wrapper = mount(<SprkMastheadDropdown idString="321" />);
  expect(wrapper.find('[data-id="321"]').length).toBe(2);
});

it('SprkMastheadDropdown: Should assign the choices header when title has a value', () => {
...
it('SprkMastheadDropdown: Should build the correct number of choices from a choices object', () => {
  const choices = {
    items: [
...
it('SprkMastheadDropdown: Should close the dropdown on click outside', () => {
  const choices = {
...
it('SprkMastheadDropdown: Should close the dropdown on keydown (Escape)', () => {
  const choices = {
    items: [{ text: 'Item 1', value: 'item-1' }],
  };
...
it('SprkMastheadDropdown: Should unmount without error', () => {
  const wrapper = mount(<SprkMastheadDropdown />);
  expect(wrapper.find('.sprk-b-Link').length).toBe(1);
  wrapper.unmount();
...
it('SprkMastheadDropdown: Should render the choices with the element specified', () => {
  const wrapper = mount(
...
it('SprkMastheadDropdown: Should pass unused keys on choice items through to the dom', () => {
  const wrapper = mount(
    <SprkMastheadDropdown
      choices={{
