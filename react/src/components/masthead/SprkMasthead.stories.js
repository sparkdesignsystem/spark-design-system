...
export const defaultStory = () => (
  <>
    <SprkMasthead
      ...
      siteLogo={<svg className="sprk-c-Masthead__logo" height="49" viewBox="0 0 175 49" width="175" xmlns="http://www.w3.org/2000/svg">
      <g fill="none">
        <path
        ...
        <g fill="#000" transform="translate(57.42 2.32)">
          ...
          />
          <path d="m29.2649092 43.0180282v-11.2907445h1.0853122v11.2907445z" />
          <path
