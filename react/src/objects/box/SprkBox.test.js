...
describe('SprkBox:', () => {
  ...
  it(
    'should set the flush spacing class in addition to the base class when' +
      ' spacing is "flush"',
    () => {
  ...
  it(
    'should set the inset-short-tiny spacing class in addition to the base' +
      ' class when spacing is "insetShortTiny"',
    () => {
      const wrapper = shallow(<SprkBox spacing="insetShortTiny" />);
      expect(
        wrapper.find('div.sprk-o-Box.sprk-o-Box--inset-short-tiny').length,
      ).toBe(1);
    },
  );

  it(
    'should set the inset-short-small spacing class in addition to the base' +
      ' class when spacing is "insetShortSmall"',
    () => {
      const wrapper = shallow(<SprkBox spacing="insetShortSmall" />);
      expect(
        wrapper.find('div.sprk-o-Box.sprk-o-Box--inset-short-small').length,
      ).toBe(1);
    },
  );

  it(
    'should set the inset-short-medium spacing class in addition to the base' +
      ' class when spacing is "insetShortMedium"',
    () => {
      const wrapper = shallow(<SprkBox spacing="insetShortMedium" />);
      expect(
        wrapper.find('div.sprk-o-Box.sprk-o-Box--inset-short-medium').length,
      ).toBe(1);
    },
  );

  it(
    'should set the inset-short-large spacing class in addition to the base' +
      ' class when spacing is "insetShortLarge"',
    () => {
      const wrapper = shallow(<SprkBox spacing="insetShortLarge" />);
      expect(
        wrapper.find('div.sprk-o-Box.sprk-o-Box--inset-short-large').length,
      ).toBe(1);
    },
  );

  it(
    'should set the inset-short-huge spacing class in addition to the base' +
      ' class when spacing is "insetShortHuge"',
    () => {
      const wrapper = shallow(<SprkBox spacing="insetShortHuge" />);
      expect(
        wrapper.find('div.sprk-o-Box.sprk-o-Box--inset-short-huge').length,
      ).toBe(1);
    },
  );

  it(
    'should set the inset-tall-tiny spacing class in addition to the base' +
      ' class when spacing is "insetTallTiny"',
    () => {
      const wrapper = shallow(<SprkBox spacing="insetTallTiny" />);
      expect(
        wrapper.find('div.sprk-o-Box.sprk-o-Box--inset-tall-tiny').length,
      ).toBe(1);
    },
  );

  it(
    'should set the inset-tall-small spacing class in addition to the base' +
      ' class when spacing is "insetTallSmall"',
    () => {
      const wrapper = shallow(<SprkBox spacing="insetTallSmall" />);
      expect(
        wrapper.find('div.sprk-o-Box.sprk-o-Box--inset-tall-small').length,
      ).toBe(1);
    },
  );

  it(
    'should set the inset-tall-medium spacing class in addition to the base' +
      ' class when spacing is "insetTallMedium"',
    () => {
      const wrapper = shallow(<SprkBox spacing="insetTallMedium" />);
      expect(
        wrapper.find('div.sprk-o-Box.sprk-o-Box--inset-tall-medium').length,
      ).toBe(1);
    },
  );

  it(
    'should set the inset-tall-large spacing class in addition to the base' +
      ' class when spacing is "insetTallLarge"',
    () => {
      const wrapper = shallow(<SprkBox spacing="insetTallLarge" />);
      expect(
        wrapper.find('div.sprk-o-Box.sprk-o-Box--inset-tall-large').length,
      ).toBe(1);
    },
  );

  it(
    'should set the inset-tall-huge spacing class in addition to the base' +
      ' class when spacing is "insetTallHuge"',
    () => {
      const wrapper = shallow(<SprkBox spacing="insetTallHuge" />);
      expect(
        wrapper.find('div.sprk-o-Box.sprk-o-Box--inset-tall-huge').length,
      ).toBe(1);
    },
  );
});
