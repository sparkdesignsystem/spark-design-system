...
describe('SprkText:', () => {
  ...
  it('should render a SprkLink if it is passed in as element and add correct class', () => {
    const wrapper = mount(<SprkText element={SprkLink} variant="one">Text</SprkText>);
