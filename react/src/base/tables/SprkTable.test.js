...
describe('SprkTable:', () => {
  ...
  it(
    'should display a table element with the correct classes if ' +
      'additionalTableClasses has a value',
    () => {
      const wrapper = shallow(
        <SprkTable additionalTableClasses="sprk-b-Table--secondary" />,
      );
      expect(wrapper.find('table').hasClass('sprk-b-Table--secondary')).toBe(
        true,
      );
    },
  );
  ...
  it(
    'should display a div element with the correct data-id if idString has a ' +
      'value',
    () => {
  ...
  it(
    'should display a div element with the correct classes if ' +
  ...
  it(
    'should display a table element with the correct classes if the variant is' +
      'secondary',
    () => {
  ...
  it(
    'should display a table element with the correct classes if the variant ' +
      'is grouped',
    () => {
      const wrapper = shallow(<SprkTable variant="grouped" />);
      expect(
        wrapper.find('table').hasClass('sprk-b-Table--grouped-columns'),
      ).toBe(true);
    },
  );
  ...
  it(
    ...
    () => {
      ...
      expect(
        wrapper.find('table').hasClass('sprk-b-Table--row-comparison'),
      ).toBe(true);
    },
  );
  ...
  it(
    ...
    () => {
      ...
      expect(
        wrapper
          .find('table')
          .hasClass('sprk-b-Table--secondary-row-comparison'),
      ).toBe(true);
    },
  );

  it(
    'should display a thead element with the correct class if the variant' +
      ' is default',
    () => {
  ...
  it(
    'should display one tr element in the thead element if columns' +
      ' are present',
    () => {
      const wrapper = shallow(
        <SprkTable
  ...
  it(
    'should display multiple tr elements in the thead element if columns' +
  ...
  it(
    'should display multiple tr elements in the tbody element if rows is' +
  ...
  it(
    'should display a th with the correct class when the variant is' +
  ...
  it(
    'should not display a thead element if the variant is' +
  ...
  it(
    'should render the appropriate number of td elements based on' +
      ' the columns prop',
    () => {
      const wrapper = shallow(
        <SprkTable
  ...
  it(
    'should render the appropriate number of td elements' +
  ...
  it(
    'should render the appropriate number of tr elements in the tbody' +
      ' based on the rows prop',
    () => {
      const wrapper = shallow(
        <SprkTable
  ...
  it(
    'should render a buttons if the button is passed in the rows prop and' +
  ...
  it(
    'should render a appropriate number of th elements when rows is passed' +
  ...
  it(
    'should render div and table elements and children if variant' + ' is html',
    () => {
