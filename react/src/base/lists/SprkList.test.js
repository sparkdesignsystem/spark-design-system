...
it('SprkList: Should display a ol element with the correct base class', () => {
  const wrapper = shallow(<SprkList element="ol" />);
  expect(wrapper.find('ol.sprk-b-List').length).toBe(1);
});

it('SprkList: Should display a ul element with the correct base class', () => {
  const wrapper = shallow(<SprkList element="ul" />);
  expect(wrapper.find('ul.sprk-b-List').length).toBe(1);
});

it('SprkList: Should render ol with correct classes when variant is indented', () => {
...
it('SprkList: Should render ul with correct classes when variant is indented', () => {
...
it('SprkList: Should add classes to ol element if additionalClasses has a value', () => {
...
it('SprkList: Should add classes to ul element if additionalClasses has a value', () => {
  const wrapper = shallow(
...
it('SprkList: Should add data-id to ol element if idString has a value', () => {
...
it('SprkList: Should add data-id to ul element if idString has a value', () => {
