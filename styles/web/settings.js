...
export const AccordionBorder = "2rem solid #e6e6e6"; // The value of border for Dividers.
...
export const CardShadowWideViewport = {"comment":"The box shadow color of the Card on wide viewports.","value":"#000000","attributes":{"category":"color","type":"shadow-color-wide-viewport"},"file":"settings","themable":true,"original":{"comment":"The box shadow color of the Card on wide viewports.","value":"rgba(0, 0, 0, 0.08)","attributes":{"category":"color"},"file":"settings","themable":true},"name":"CardShadowColorWideViewport","path":["card","shadow-color-wide-viewport"]}; // The box shadow of the Card on wide viewports.
...
export const CardShadowStandout = {"comment":"The box shadow color of the Standout Card variant on narrow viewports.","value":"#000000","file":"settings","attributes":{"category":"color","type":"shadow-color-standout"},"themable":true,"original":{"comment":"The box shadow color of the Standout Card variant on narrow viewports.","value":"rgba(0, 0, 0, 0.1)","file":"settings","attributes":{"category":"color"},"themable":true},"name":"CardShadowColorStandout","path":["card","shadow-color-standout"]}; // The box shadow of the Standout Card variant on narrow viewports.
export const CardShadowStandoutWideViewport = {"comment":"The box shadow color of the Standout Card variant on wide viewports.","value":"#000000","file":"settings","attributes":{"category":"color","type":"shadow-color-standout-wide-viewport"},"themable":true,"original":{"comment":"The box shadow color of the Standout Card variant on wide viewports.","value":"rgba(0, 0, 0, 0.1)","file":"settings","attributes":{"category":"color"},"themable":true},"name":"CardShadowColorStandoutWideViewport","path":["card","shadow-color-standout-wide-viewport"]}; // The box shadow of the Standout Card variant on wide viewports.
...
export const InputHugeLabelTop = {"comment":"The height value for Huge Inputs.","value":"64rem","attributes":{"category":"size","type":"huge","item":"height"},"file":"settings","themable":true,"original":{"comment":"The height value for Huge Inputs.","value":"{text-input.huge.height.value}","attributes":{"category":"size"},"file":"settings","themable":true},"name":"InputHugeHeight","path":["input","huge","height"]}; // The top value for Huge Input labels. This adjusts how far the label is from the top of the container.
...
export const TextInputHugeLabelTop = {"comment":"The height value for Huge Inputs.","value":"64rem","attributes":{"category":"size","type":"huge","item":"height"},"file":"settings","themable":true,"original":{"comment":"The height value for Huge Inputs.","value":"{text-input.huge.height.value}","attributes":{"category":"size"},"file":"settings","themable":true},"name":"InputHugeHeight","path":["input","huge","height"]}; // Todo deprecate, The top value for Huge Input labels. This adjusts how far the label is from the top of the container.
...
export const SelectInputHugeIconMarginTop = {"comment":"The height value for Huge Inputs.","value":"64rem","attributes":{"category":"size","type":"huge","item":"height"},"file":"settings","themable":true,"original":{"comment":"The height value for Huge Inputs.","value":"{text-input.huge.height.value}","attributes":{"category":"size"},"file":"settings","themable":true},"name":"InputHugeHeight","path":["input","huge","height"]}; // The margin-top value for icons in Huge Select Inputs.
...
export const LinkSimpleHoverBorderBottom = {"comment":"The underline color value of Simple Links on hover.","value":"#c8102e","attributes":{"category":"color","type":"simple","item":"hover","subitem":"underline","state":"color"},"file":"settings","themable":true,"original":{"comment":"The underline color value of Simple Links on hover.","value":"{red.value}","attributes":{"category":"color"},"file":"settings","themable":true},"name":"LinkSimpleHoverUnderlineColor","path":["link","simple","hover","underline","color"]}; // The underline style of visited Simple Links on hover.
...
export const LinkSimpleBorderBottom = {"comment":"The underline color value of Simple Links.","value":"transparent","attributes":{"category":"content","type":"simple","item":"underline","subitem":"color"},"file":"settings","themable":true,"original":{"comment":"The underline color value of Simple Links.","value":"transparent","attributes":{"category":"content"},"file":"settings","themable":true},"name":"LinkSimpleUnderlineColor","path":["link","simple","underline","color"]}; // The underline style of Simple Links.
...
export const LinkLightHoverBorderBottom = {"comment":"The underline color value of Light Links on hover.","value":"#ffffff","attributes":{"category":"color","type":"light","item":"hover","subitem":"underline","state":"color"},"file":"settings","themable":true,"original":{"comment":"The underline color value of Light Links on hover.","value":"{white.value}","attributes":{"category":"color"},"file":"settings","themable":true},"name":"LinkLightHoverUnderlineColor","path":["link","light","hover","underline","color"]}; // The underline style of Light Links on hover.
...
export const LinkLightBorderBottom = {"comment":"The underline color value of Light Links.","value":"transparent","attributes":{"category":"content","type":"light","item":"underline","subitem":"color"},"file":"settings","themable":true,"original":{"comment":"The underline color value of Light Links.","value":"transparent","attributes":{"category":"content"},"file":"settings","themable":true},"name":"LinkLightUnderlineColor","path":["link","light","underline","color"]}; // The underline style of Light Links.
