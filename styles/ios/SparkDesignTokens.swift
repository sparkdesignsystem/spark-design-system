...
public class SparkDesignTokens {
    ...
    public static let sprkCheckboxHugeContainerDisabledBorder = CGFloat(0.00) solid UIColor(red: 0.553, green: 0.553, blue: 0.549, alpha:1)
    public static let sprkCheckboxHugeContainerDisabledBorderColor = UIColor(red: 0.553, green: 0.553, blue: 0.549, alpha:1)
    public static let sprkCheckboxHugeContainerDisabledBorderWidth = CGFloat(0.00)
    public static let sprkCheckboxHugeContainerFocusBorder = CGFloat(2.00) solid UIColor(red: 0.376, green: 0.227, blue: 0.631, alpha:1)
