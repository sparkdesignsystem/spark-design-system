...
export const variants = [
  {
    name: 'Page Title',
    description: 'The page title is used on primary pages that contain multiple jumping off points, as well as core product features and flows. It should only be used once at the top of the main content of a page.',
